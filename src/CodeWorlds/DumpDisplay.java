...
/* CodeWorlds.Display keeps track of a list of Displayables, and produces, on each
 * |update| call, a textual 2-D display of their location, showing the toString
 * value of each CodeWorlds.Displayable at its current location, with X location ascending
 ...
 *
 * If any CodeWorlds.Displayable falls outside the allowed index range, simply drop it
 * from the display.
 */
